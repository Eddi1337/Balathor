...
const ENEMY_CAMPS = [
  { id: "north_woods", x: -54, y: -86, size: 4, tier: 1 },
  { id: "east_copse", x: 88, y: -38, size: 5, tier: 1 },
  { id: "south_ford", x: 62, y: 82, size: 4, tier: 1 },
  { id: "west_bramble", x: -92, y: 56, size: 5, tier: 1 },
  { id: "green_crossing", x: 154, y: 24, size: 4, tier: 1 },
  { id: "reed_watch", x: -38, y: 118, size: 4, tier: 1 },
  { id: "briar_gate", x: 26, y: -152, size: 5, tier: 2 },
  { id: "moss_ring", x: -146, y: 2, size: 5, tier: 2 },
  { id: "deep_pines", x: -118, y: -42, size: 6, tier: 2, boss: true },
  { id: "old_road", x: 42, y: -116, size: 6, tier: 2, boss: true },
  { id: "far_meadow", x: -176, y: 148, size: 6, tier: 2, boss: true },
  { id: "flower_den", x: 112, y: 146, size: 5, tier: 2 },
  { id: "thistle_bend", x: -208, y: 92, size: 5, tier: 2 },
  { id: "clover_ruins", x: 16, y: 188, size: 6, tier: 3, boss: true },
  { id: "oasis_raiders", x: 184, y: 94, size: 7, tier: 3, boss: true },
  { id: "sunken_dunes", x: 116, y: 170, size: 5, tier: 3 },
  { id: "glass_wash", x: 232, y: 118, size: 6, tier: 4 },
  { id: "scorpion_run", x: 176, y: 202, size: 5, tier: 4 },
  { id: "saffron_outpost", x: 264, y: 176, size: 7, tier: 5, boss: true },
  { id: "salt_basin", x: 132, y: 246, size: 5, tier: 4 },
  { id: "frost_ridge", x: -184, y: -96, size: 7, tier: 3, boss: true },
  { id: "snow_hollow", x: -112, y: -174, size: 5, tier: 3 },
  { id: "icefall_post", x: -236, y: -132, size: 5, tier: 4 },
  { id: "white_gulch", x: -172, y: -222, size: 6, tier: 4 },
  { id: "rime_circle", x: -264, y: -198, size: 7, tier: 5, boss: true },
  { id: "pine_barricade", x: -98, y: -246, size: 5, tier: 4 },
  { id: "ember_watch", x: 194, y: -120, size: 7, tier: 3, boss: true },
  { id: "ash_fields", x: 104, y: -190, size: 5, tier: 3 },
  { id: "cinder_ford", x: 238, y: -172, size: 6, tier: 4 },
  { id: "charred_steps", x: 156, y: -246, size: 5, tier: 4 },
  { id: "red_glass_camp", x: 282, y: -226, size: 7, tier: 5, boss: true },
  { id: "smoke_hollow", x: 92, y: -274, size: 5, tier: 4 },
];
